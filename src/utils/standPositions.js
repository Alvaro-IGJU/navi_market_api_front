...
export const getStandCoordinates = (position) => {
  ...
  const standMap = {
    ...
    1: { position: [-23, 0.2, 11.3], rotation: [0, 0.86, 0] },
    2: { position: [0.5, 0.2, 63], rotation: [0, 3.14, 0] },
    3: { position: [30, 0.2, 34], rotation: [0, Math.PI / -2, 0] },
    4: { position: [23, 0.2, 57], rotation: [0, 4, 0] },
    5: { position: [-23, 0.2, 57], rotation: [0, 2.5, 0] },
  };
