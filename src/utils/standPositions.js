...
export const getStandCoordinates = (position) => {
  ...
  const standMap = {
    ...
    6: { position: [6.5, -18, 15.1], rotation: [0, 10.65, 0], areaRadius: 2.4},
    7: { position: [15.4, -18, 24], rotation: [0, 9.8, 0], areaRadius: 2.4},
    8: { position: [15, -18, 37], rotation: [0, 2.75, 0], areaRadius: 2.4},
    9: { position: [5.9, -18, 46], rotation: [0, 1.9, 0], areaRadius: 2.4},
    10: { position: [-6.4, -18, 45], rotation: [0, 1.2, 0], areaRadius: 2.4},
    11: { position: [-15, -18, 36], rotation: [0, 0.4, 0], areaRadius: 2.4},
    12: { position: [-15, -18, 23], rotation: [0, -0.5, 0], areaRadius: 2.4},
    13: { position: [-5.8, -18, 15], rotation: [0, -1.2, 0], areaRadius: 2.4},
    14: { position: [0, -18, 20.5], rotation: [0, -11, 0], areaRadius: 2.4},
    15: { position: [9.6, -18, 30], rotation: [0, -6.3, 0], areaRadius: 2.4},
