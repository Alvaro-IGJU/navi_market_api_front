...
Command: npx gltfjsx@6.5.3 public/models/6755d1bcfc007706c1949bec.glb -o src/components/Avatar.jsx -k -r public 
*/
...
export function Avatar({ animation, ...props }) {
  const { scene } = useGLTF('/models/6755d1bcfc007706c1949bec.glb');
...
useGLTF.preload('/models/6755d1bcfc007706c1949bec.glb')
